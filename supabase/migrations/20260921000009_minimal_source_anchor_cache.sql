-- K01: keep the independent semantic review, but make its source anchor a
-- minimal literal rendering that never invents likely activities or intent.
...
select
  message_id, chat_id, viewer_id, learning_language,
  primary_known_language, language_revision, source_version,
  'minimal_source_anchor_cache_invalidated'
