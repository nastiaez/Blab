-- L05: require complete non-Latin word metadata and regenerate translations
-- under the stronger correction and tense contract.
...
begin
  ...
  if p_cache_contract_version <> 'complete-language-aids-v3' then
    return false;
  end if;
  perform set_config(
...
select
  message_id, chat_id, viewer_id, learning_language,
  primary_known_language, language_revision, source_version,
  'language_aids_cache_invalidated'
